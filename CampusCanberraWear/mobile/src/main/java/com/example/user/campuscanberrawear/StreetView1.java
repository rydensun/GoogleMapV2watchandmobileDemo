 ...
 */
public class StreetView1 extends AppCompatActivity implements OnStreetViewPanoramaReadyCallback {
    LatLng entrance1 = new LatLng(-35.238542, 149.090433);
    ...
    public void onStreetViewPanoramaReady(StreetViewPanorama streetViewPanorama) {
        ...
        streetViewPanorama.setPosition(entrance1);
